...
plt.title("PJM Load", fontsize=18)
plt.show()
...
def create_features(df, label=None):
    ...
    """
    df['date'] = df.index # Setting date from the index for feature creation.
    # Extracting various time components as features
    ...
    #Creating lag and rolling window statistics as features

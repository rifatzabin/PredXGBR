...
reg = pickle.load(open('xgboost_model2_pjmw_load_hourly.model', 'rb'))
...
plt.title("PJMW Load Prediction", fontsize=21)
...
ax.set_xbound(lower='01-03-2016', upper='02-03-2016')
ax.set_ylim(3500, 9000)
plot = plt.suptitle('January 2016 Forecast vs Actuals', fontsize=17)
...
f.set_figwidth(15)
_ = pjme_all[['MW_Prediction','Load']].plot(ax=ax, style=['-','.'], color=['orange', 'green'])
ax.set_xbound(lower='01-03-2016', upper='01-10-2016')
ax.set_ylim(3500, 9000)
